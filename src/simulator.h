...
public:
    ...
    void print_results(int N, vector<vector<string>> hands, vector<vector<int>> results);
    void print_play(int N, vector<vector<string>> known_hands_str, vector<int> comm_hand, vector<vector<int>> results);
